...
export const PEG_TYPES: PegConfig[] = [
  ...
  },
  {
    ...
    unlockChapter: 4, desc: '弹珠数值 +25，高阶加法放大', maxLevel: 25,
  ...
  },
  {
    ...
    unlockChapter: 4, desc: '弹珠数值 ×3，高阶倍增', maxLevel: 15,
  ...
  },
  {
    ...
    unlockChapter: 3, desc: '弹珠数值 ÷3，更激进的复位', maxLevel: 8,
  ...
  // 指数系：1.1 次方，升级 +0.1
  {
    ...
    unlockChapter: 4, desc: '弹珠数值 1.1 次方，升级后指数 +0.1', maxLevel: 20,
  ...
  },
  {
    ...
    unlockChapter: 4, desc: '弹珠数值 +25%，高阶百分比', maxLevel: 20,
