...
export const AUTO_DROPPERS: AutoDropperConfig[] = [
  {
    ...
    maxSpeedLevel: 8, maxCount: 10, icon: 'auto1',
  ...
  },
  {
    ...
    maxSpeedLevel: 8, maxCount: 10, icon: 'auto2',
  ...
  },
  {
    ...
    maxSpeedLevel: 6, maxCount: 5, icon: 'auto3',
  ...
  },
  {
    ...
    maxSpeedLevel: 6, maxCount: 3, icon: 'double',
    desc: '每次投下 2 颗弹珠',
  ...
  },
  {
    ...
    maxSpeedLevel: 5, maxCount: 3, icon: 'auto3',
  ...
  },
  {
    ...
    maxSpeedLevel: 5, maxCount: 2, icon: 'double',
    desc: '每次投下 3 颗弹珠',
