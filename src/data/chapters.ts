...
export const AUTO_DROPPERS: AutoDropperConfig[] = [
  { id: 'I', name: '自动投弹器 I', interval: 3.0, cost: 500, unlockChapter: 1, icon: 'auto1' },
  { id: 'II', name: '自动投弹器 II', interval: 1.5, cost: 5000, unlockChapter: 2, icon: 'auto2' },
  { id: 'III', name: '自动投弹器 III', interval: 0.5, cost: 50000, unlockChapter: 3, icon: 'auto3' },
  { id: 'multi', name: '多重投弹', interval: 1.0, cost: 100000, unlockChapter: 4, icon: 'double' },
];
...
export const CRYSTAL_UPGRADES: CrystalUpgrade[] = [
  {
    ...
    icon: 'coin', desc: '每一周目都生效的金币加成',
  },
  {
    id: 'startGold', name: '初始金币', maxLevel: 10, baseCost: 20, costGrowth: 1.6,
    effect: (lvl) => `新周目开局金币 +${shortNum(lvl * 1000)}`,
    getValue: (lvl) => lvl * 1000,
    icon: 'box', desc: '每次归零后获得启动资金',
  },
  {
