...
export const DIALOGUES: Dialogue[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      { speaker: 'zero', portrait: 'zero', text: '它会释放"冰霜新星"——一旦命中，你的弹珠会被冻住，下落变慢。' },
      { speaker: 'linn', portrait: 'linn', text: '弹珠被冻住？那还能打到它吗？' },
      { speaker: 'zero', portrait: 'zero', text: '能。冰冻只是减速，不是停止——多投几颗，靠数量压过去。' },
      { speaker: 'linn', portrait: 'linn', text: '好……我试试！为了活下去，我不能退缩！' },
      { speaker: 'boss_frost', portrait: 'boss_frost', text: '……愚者……迎向……寒冰……' },
    ],
  },
  {
  ...
  },
  {
    ...
    lines: [
      ...
      { speaker: 'linn', portrait: 'linn', text: '它说话了！骨头拼成的东西还能说话？' },
      { speaker: 'boss_skull', portrait: 'boss_skull', text: '遗迹的秘密……不可带走……归零……' },
      { speaker: 'zero', portrait: 'zero', text: '骷髅守卫。它会召唤"骨盾"护体，先击碎骨盾，才能伤到本体。' },
      { speaker: 'lily', portrait: 'lily', text: '它身上套着一圈白白的数字！很硬的样子！' },
      { speaker: 'zero', portrait: 'zero', text: '没错——那是骨盾，会吸收下一次伤害。先用小数值弹珠磨掉它，再下重手。' },
      { speaker: 'linn', portrait: 'linn', text: '明白了。莉莉，帮我盯着骨盾还有没有！' },
      { speaker: 'lily', portrait: 'lily', text: '交给我！骨盾一碎我就喊你！' },
      { speaker: 'boss_skull', portrait: 'boss_skull', text: '……骨……不灭……汝……终将……归零……' },
